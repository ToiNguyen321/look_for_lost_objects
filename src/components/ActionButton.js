...
import { StyleSheet, Animated, TouchableOpacity, Keyboard, View, SafeAreaView, Dimensions, Platform } from 'react-native';
...
export default function ActionButton({
    buttonsDefault, buttonsChildren,
    showChildren, itemWidth,
    spaceBetweenButton, right,
    backgroundColorText, colorText,
    bottom, ...props
}) {
    ...
    const { ITEM_WIDTH, ITEM_HEIGHT, BOTTOM, RIGHT, MARGIN_TOP_ITEM } = CONFIG.current
                    ...
                    <Animated.View
                        onLayout={(e) => {
                            ...
                            if (buttonsDefault?.length > 2) {
                                heightMinus = (buttonsDefault?.length - 2) * ITEM_HEIGHT + BOTTOM;
                            }
                    ...
                    >
                        ...
                        >
                            <View style={{
                                ...
                                {
                                    buttonsChildren.map(({ label, icon, backgroundColor, onPress, ...propsBtn }, index) => {
                                        const stylesViewIcon = index !== buttonsChildren.length - 1 ? styleViewIcon : {
                                            transform: [{
                                                rotate: iconRotate
                                            }]
                                        };
                                            ...
                                            >
                                                {
                                                    ...
                                                    && (<Animated.View style={[styles.viewText, styleText]}>
                                                        <Animated.Text numberOfLines={2} style={[
                                                            styles.textChildren,
                                                            { opacity: animatedText.current },
                                                            { backgroundColor: backgroundColorText, color: colorText }
                                                        ]}>
                                                            {label}
                                                        </Animated.Text>
                                                    </Animated.View>)
